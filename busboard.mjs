...
async function fetchStopCode(lat, long){
    ...
    const response1 = await fetch(`https://api.tfl.gov.uk/StopPoint/?lat=${lat}&lon=${long}&stopTypes=NaptanPublicBusCoachTram&radius=400`);
...
let stopCode1 = '490008660S';
let stopCode2 = '490008660N';
...
fetchBuses(stopCode1);
fetchBuses(stopCode2);